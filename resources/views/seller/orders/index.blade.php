...
<div class="space-y-6">
    <div>
        ...
        <p class="text-sm text-gray-300">Manage and fulfill your orders</p>
    </div>
    ...
    <div class="glass rounded-xl border border-yellow-500/10 overflow-hidden">
        <div class="p-4 border-b border-white/5 flex items-center gap-3">
            <input type="text" placeholder="Search orders..." class="w-full px-3 py-2 rounded bg-white/5 text-gray-100 placeholder-gray-400 border border-white/10" />
            ...
            <table class="min-w-full text-sm">
                ...
                <tbody class="divide-y divide-white/5">
                    <tr>
                        ...
                        <td class="px-4 py-3"><button class="px-2 py-1 text-xs rounded bg-yellow-500 text-gray-900">View</button></td>
                    </tr>
                </tbody>
            </table>
        </div>
