...
<div class="space-y-8">
    <div>
        ...
        <p class="text-sm text-gray-300">Manage your seller account info without leaving your dashboard.</p>
    </div>

    @include('profile.partials.dashboard-summary', ['user' => $user, 'roleLabel' => 'Seller'])
