<nav x-data="{ open: false }"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            <div class="flex items-center">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}" aria-label="Home" class="flex items-center gap-3 group">
                        ...
                        <span
                            class="text-yellow-500 text-base sm:text-xl font-bold group-hover:text-yellow-400 transition-colors duration-300">{{ config('app.name', 'Zentara') }}</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:flex sm:ml-16">
                    ...
                    <x-user-nav-link href="{{ route('products.index') }}" :active="request()->routeIs('products.*')"
                        class="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-300 hover:text-yellow-400 transition-colors duration-300">
                        {{ __('Products') }}
                    </x-user-nav-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6 space-x-4">
                <!-- Search Icon -->
                <button
                    class="p-2 text-gray-300 hover:text-yellow-400 hover:bg-gray-800 rounded-lg transition-all duration-200"
                    aria-label="Search">
    ...
    <div :class="{'block': open, 'hidden': ! open}"
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-user-responsive-nav-link href="{{ route('products.index') }}" :active="request()->routeIs('products.*')"
                class="block pl-6 pr-4 py-3 border-l-4 border-transparent text-base font-medium text-gray-300 hover:text-yellow-400 hover:border-yellow-500 hover:bg-gray-800 transition-all duration-200">
                {{ __('Products') }}
            </x-user-responsive-nav-link>
        ...
        @auth
            ...
            <div class="pt-4 pb-1 border-t border-yellow-500/20">
                ...
                <div class="mt-3 space-y-1">
                    <x-user-responsive-nav-link href="{{ route('profile.show') }}"
                    ...
                    @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
                        ...
                        @can('create', Laravel\Jetstream\Jetstream::newTeamModel())
                            <x-user-responsive-nav-link href="{{ route('teams.create') }}"
