    ...
    <section class="py-16 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-12">
                <form method="GET" action="{{ route('products.index') }}" class="max-w-2xl mx-auto">
                    <div class="relative">
                        ...
                        <button
                            class="absolute right-2 top-2 px-6 py-2 bg-gradient-to-r from-gray-900 to-black text-white rounded-full hover:from-black hover:to-gray-900 transition-all duration-300 shadow-lg">
                            Search
                        </button>
                    </div>
                </form>
                    ...
                    <div class="max-w-md mx-auto">
                        <div class="w-24 h-24 mx-auto mb-6 bg-gray-200 rounded-full flex items-center justify-center">
                            <svg class="w-12 h-12 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2M4 13h2m13-8l-4 4-4-4m2-3v6">
                                </path>
                            </svg>
                        </div>
                        <h3 class="text-2xl font-semibold text-gray-900 mb-3">No Products Found</h3>
                        <p class="text-gray-600 leading-relaxed">We couldn't find any products matching your criteria. Try
                            adjusting your search or browse our full collection.</p>
                    </div>
                </div>
            @else
            <!-- Products Grid -->
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-16">
                ...
                <div
                    class="group relative bg-white rounded-xl shadow-sm hover:shadow-2xl border border-gray-100 overflow-hidden transition-all duration-500 hover:-translate-y-1">
                    ...
                    <div class="p-4 space-y-3">
                        <div class="space-y-1">
                            <a href="{{ route('products.show', $product->id) }}" class="block group/link">
                                <h3
                                    class="text-lg font-semibold text-gray-900 group-hover/link:text-yellow-600 transition-colors duration-200 leading-tight line-clamp-2">
                                    {{ $product->name }}
                                </h3>
                            </a>
                        ...
                        <div class="mt-8 flex flex-col sm:flex-row gap-3">
                            ...
                            @else
                                <button class="px-6 py-3 bg-gray-700 text-gray-300 rounded-lg cursor-not-allowed"
                                    disabled>Cart disabled for admin</button>
                            @endunless
